    	...
    	<td align="center"> 
	        <table cellspacing="0" cellpadding="0" > 
				...
				<tr>						
					...
					<button href="javascript:void(0)" onMouseUp="alert('Se ha marcado como favorito')"  name="maillist" type="button"  id="favorito" onclick="agregar_favoritos('<?php echo h($protesi['Protesi']['idprotesis']); ?>')">Favorito</button>
